...
import com.amazing.poi.excel.read.SingleSheetRead;
 ...
 * @author amzing.
 * @version 0.1
 * @time 2019/10/22 23:41
 * @since 0.1
 */
public class SingleSheetReadTest {

    @Test
    public void errorHeadMapTest() throws IOException {
        Map<String,String> headMap = new LinkedHashMap<>();
        headMap.put("name","姓名");
        headMap.put("age","年龄");
        headMap.put("gender","性别");

        String path = "C:\\Users\\amazing\\Desktop\\demo1.xls";
    ...
    @Test
    public void singleReadTest() throws IOException {
